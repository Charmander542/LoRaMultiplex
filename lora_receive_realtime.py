...
class lora_receive_realtime(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.lora_lora_receiver_0_0_0, 'frames'), (self.lora_message_socket_sink_0, 'in'))
        self.msg_connect((self.lora_lora_receiver_0_0_1, 'frames'), (self.lora_message_socket_sink_0, 'in'))
        self.msg_connect((self.lora_lora_receiver_0_0_2, 'frames'), (self.lora_message_socket_sink_0, 'in'))
        self.msg_connect((self.lora_lora_receiver_0_0_3, 'frames'), (self.lora_message_socket_sink_0, 'in'))
