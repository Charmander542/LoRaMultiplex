...
# Title: Squelch10Colliison
# Generated: Fri Aug  1 18:56:57 2025
##################################################
...
class squelch10colliison(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Squelch10Colliison")
...
def main(top_block_cls=squelch10colliison, options=None):
