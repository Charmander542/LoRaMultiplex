...
# Title: Squelch60
# Generated: Wed Jul 30 15:15:08 2025
##################################################
...
class squelch60(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Squelch60")
        ...
        self.target_freq = target_freq = 908.3e6
        ...
        self.capture_freq = capture_freq = 908.3e6
...
def main(top_block_cls=squelch60, options=None):
