...
# Title: Rtl Squelch
# Generated: Fri Jul 25 16:21:18 2025
##################################################
...
class rtl_squelch(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Rtl Squelch")
        ...
        self.capture_freq = capture_freq = 902.3e6
        ...
        self.rtlsdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + 'rtl=1' )
        self.rtlsdr_source_0.set_sample_rate(samp_rate)
        self.rtlsdr_source_0.set_center_freq(910.3e6, 0)
...
def main(top_block_cls=rtl_squelch, options=None):
