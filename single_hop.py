...
# Title: Hopping with Resampler (Fixed)
...
# MODIFIED: Import 'filter' module itself, along with firdes from it
...
class single(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.resampled_rate = resampled_rate = samp_rate * 5.0 / 8.0
        ...
        # MODIFIED: Re-added the Rational Resampler block with the correct import
        ...
        # MODIFIED: Connect source -> resampler -> lora_receiver
        self.connect((self.uhd_usrp_source_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.lora_lora_receiver_0, 0))

        # The FFT plot remains connected to the original high-rate source
    ...
    def set_samp_rate(self, samp_rate):
        ...
        # Recalculate resampled rate if main rate changes
        self.resampled_rate = self.samp_rate * 5.0 / 8.0
        # This would require a set_samp_rate method on the lora_receiver if it exists
        # self.lora_lora_receiver_0.set_samp_rate(self.resampled_rate)
