...
# Title: Squelch50
# Generated: Wed Jul 30 15:15:51 2025
##################################################
...
class squelch50(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Squelch50")
        ...
        self.target_freq = target_freq = 907.3e6
        ...
        self.capture_freq = capture_freq = 907.3e6
...
def main(top_block_cls=squelch50, options=None):
